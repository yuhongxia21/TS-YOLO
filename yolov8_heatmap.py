...
def get_params():
    params = {
        # 'weight': 'runs/our TS-YOLO/trian/weights/best.pt',
        # 'weight': 'runs/yolov8n/trian/weights/best.pt',
        'weight': 'heatmap/best.pt',
        # 'cfg': 'ultralytics/cfg/models/v8/yolov8n-RepC3.yaml',
...
if __name__ == '__main__':
    ...
    model(r'heatmap/test2.jpg', 'heatmap/test')